...
tf.write_operation(Operation(OperationType.define, ["test_str", Value(tf.builder, DataStructureType(DataStructureTypeOptions.array, ScalarType.c8, len(test_str)), test_str)]))

tf.write_operation(Operation(OperationType.call, [("print",), tf.get_variable("test_str"), tf.get_variable("ret_val")]))
